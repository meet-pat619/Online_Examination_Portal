...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="my-5">        
        <asp:Button ID="Button1" runat="server" Text="Add Exam" CssClass="btn btn-primary mb-3" OnClick="btn_AddExam" />
    ...
    <div class="my-5">        
        <asp:Button ID="Button2" runat="server" Text="Add Student" CssClass="btn btn-primary mb-3" OnClick="btn_AddStudent" />
